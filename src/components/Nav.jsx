    ...
    return (
        <nav className={params.myClass}>
            <div className="container">
                <a className="navbar-brand d-inline-block align-top" href="/#">K.H</a>
                ...
                <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul className="nav navbar-nav navbar-right">
                        ...
                        <li className="nav-item" id="about"><a className="nav-link" href="/#/about">ABOUT US</a></li>
                        <li className="nav-item dropdown">
                            ...
                            <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a className="dropdown-item" href="/#/write">LOGIN</a>
